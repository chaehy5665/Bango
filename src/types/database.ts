...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      venue_images: {
        Row: {
          ...
          id: string
          image_category: Database["public"]["Enums"]["image_category"]
          image_url: string
          updated_at: string
          venue_id: string
        }
      ...
      venue_peripherals: {
        ...
        Relationships: [
          {
            foreignKeyName: "venue_peripherals_venue_id_fkey"
            columns: ["venue_id"]
            isOneToOne: false
            referencedRelation: "venues"
            referencedColumns: ["id"]
    ...
    Enums: {
      image_category: "exterior" | "interior" | "setup" | "menu"
      peripheral_type: "keyboard" | "mouse" | "headset" | "chair"
    }
    CompositeTypes: {
      geometry_dump: {
        path: number[] | null
